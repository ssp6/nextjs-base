...
const testimonials = [
  {
    ...
    profileImage: '/images/sarah-l.webp',
    locationImage: '/images/sarah-l-trip.webp',
    color: '#5EC053',
  },
  {
    ...
    name: 'John D.',
    title: 'Photographer',
    profileImage: '/images/john-d.webp',
    locationImage: '/images/john-d-trip.webp',
    color: '#5CC3CB',
  },
  {
    ...
    name: 'Peter P.',
    title: 'Musician',
    profileImage: '/images/peter-p.webp',
    locationImage: '/images/peter-p-trip.webp',
    color: '#de7593',
  },
  {
    ...
    name: 'Sally H.',
    title: 'Nurse',
    profileImage: '/images/sally-h.webp',
    locationImage: '/images/sally-h-trip.webp',
    color: '#a734d2',
  },
]
